package com.tealcubegames.minecraft.spigot.nobadtasers.v1_10_2_R1;
    ...
    private AbstractNBTCompound read(NBTTagCompound compound) {
        compound.c().forEach(key -> {
            ...
            if (value instanceof NBTTagCompound) {
                super.value.put(key, new com.tealcubegames.minecraft.spigot.nobadtasers.v1_10_R1.NBTCompoundImpl().read((NBTTagCompound) value));
